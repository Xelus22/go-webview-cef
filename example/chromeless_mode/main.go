...
<body>
	...
	if w == nil {
		log.Fatal("Failed to create browser")
	}

	log.Println("Starting CEF 145 Chromeless App...")
	log.Println("Features: No URL bar, no tabs, no Chrome UI - just content!")
